...
<?php 
	...
	if(isset($_POST['adduser']))
	{
		...
		password, notelp, alamat, role) values('$namalengkap','$email',
		'$password','$notelp','$alamat','$role')");
		if ($tambahuser){
														...
														<form method="post" enctype="multipart/form-data">
															<div class="modal-body">
																...
																<input type="text" name="namalengkap"
																	value="<?=$p['namalengkap'];?>" class="form-control"
																	required>
																<br>
																Email
																...
																<input type="text" name="notelp"
																	value="<?=$p['notelp'];?>" class="form-control"
																	required>
																<br>
                                                                Alamat
																<input type="text" name="alamat"
																	value="<?=$p['alamat'];?>" class="form-control"
																	required>
																<br>
											...
											<div class="modal fade" id="delete<?=$id;?>">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form method="post">
															<div class="modal-body">
																Apakah anda yakin ingin menghapus <?=$p['namalengkap'];?>?
