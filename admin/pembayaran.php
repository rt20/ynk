														...
														<form method="post" enctype="multipart/form-data">
															<div class="modal-body">
																...
																<input type="text" name="metode"
																	value="<?=$p['metode'];?>" class="form-control"
																	required>
																<br>
																No. Rekening
																<input type="text" name="norek"
																	value="<?=$p['norek'];?>" class="form-control"
																	required>
																<br>
																Atas Nama
																<input type="text" name="an"
																	value="<?=$p['an'];?>" class="form-control"
																	required>
																<br>
																URL Logo
																<input type="text" name="logo"
																	value="<?=$p['logo'];?>" class="form-control"
																	required>
																<br>
																...
																<button type="submit" class="btn btn-primary"
																	name="updatepembayaran">Submit</button>
															</div>
														</form>
													</div>
												</div>
											...
											<div class="modal fade" id="delete<?=$id;?>">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form method="post">
															<div class="modal-body">
																Apakah anda yakin ingin menghapus <?=$p['metode'];?>?
																...
																<button type="submit" class="btn btn-danger"
																	name="hapuspembayaran">Hapus</button>
															</div>
														</form>
													</div>
												</div>
