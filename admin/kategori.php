														...
														<form method="post" enctype="multipart/form-data">
															<div class="modal-body">
																...
																<input type="text" name="namakategori"
																	value="<?=$p['namakategori'];?>" class="form-control"
																	required>
																<br>
																Tanggal Dibuat
																<input type="text" name="tgldibuat"
																	value="<?=$p['tgldibuat'];?>" class="form-control"
																	required>
																<br>
																...
																<button type="submit" class="btn btn-primary"
																	name="updatekategori">Submit</button>
															</div>
														</form>
													</div>
												</div>
											...
											<div class="modal fade" id="delete<?=$id;?>">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form method="post">
															<div class="modal-body">
																Apakah anda yakin ingin menghapus <?=$p['namakategori'];?>?
																...
																<button type="submit" class="btn btn-danger"
																	name="hapuskategori">Hapus</button>
															</div>
														</form>
													</div>
												</div>
